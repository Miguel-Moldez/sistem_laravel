...
<head>
    ...
    <style>
        ...
        .text-section {
            width: 100%;
            text-align: center;
            margin-top: 20px; /* Added space above the text section */
        }
        h1 {
            color: #11468F;
            font-size: 3em;
        ...
        .service {
            ...
            height: 250px; /* Reduced box height */
...
<body>
    ...
    <div class="container">
        ...
        <div class="service">
            ...
            <p>Identification cards to residents.</p>
        ...
        <div class="service">
            ...
            <a href="{{ route('business-permits') }}">Click to Apply</a>
        </div>
    </div>
</body>
