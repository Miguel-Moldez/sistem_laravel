...
<section class="flex justify-center p-6">
    ...
    >
        ...
        <div class="relative flex w-full items-stretch">
            <img
                src="{{ asset('images/choose-us-image-02.png') }}"
        ...
        <div class="relative flex items-center gap-6">
            ...
            <div>
                ...
                <p class="mt-4 text-sm/relaxed">
                    Discover amazing features and take the first step towards something new. Whether you’re a beginner or experienced user, our platform has everything you need.
                </p>
...
<section class="grid gap-6 lg:grid-cols-3 lg:gap-8 p-6">
    ...
    <a href="#article1" class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
        <div class="relative flex w-full items-stretch">
            <img src="{{ asset('images/courses-01.jpg') }}" alt="News Image 1" class="aspect-video w-full h-full object-cover rounded-[10px] drop-shadow-[0px_4px_34px_rgba(0,0,0,0.06)] dark:hidden">
        ...
        <div class="relative">
            <h2 class="text-xl font-semibold text-black dark:text-white">Joana, binalikan yung EX!!</h2>
            <p class="mt-4 text-sm/relaxed">Brief description for the first news article.</p>
        </div>
    </a>
    ...
    <a href="#article2" class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
        <div class="relative flex w-full items-stretch">
            <img src="{{ asset('images/courses-02.jpg') }}" alt="News Image 2" class="aspect-video w-full h-full object-cover rounded-[10px] drop-shadow-[0px_4px_34px_rgba(0,0,0,0.06)] dark:hidden">
            <div class="absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900"></div>
        </div>
        <div class="relative">
            <h2 class="text-xl font-semibold text-black dark:text-white">Hazel, natae sa SM Bicutan, Nahimatay!!</h2>
            <p class="mt-4 text-sm/relaxed">Brief description for the second news article.</p>
        </div>
    </a>
    ...
    <a href="#article3" class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
        <div class="relative flex w-full items-stretch">
            <img src="{{ asset('images/courses-03.jpg') }}" alt="News Image 3" class="aspect-video w-full h-full object-cover rounded-[10px] drop-shadow-[0px_4px_34px_rgba(0,0,0,0.06)] dark:hidden">
            <div class="absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900"></div>
        </div>
        <div class="relative">
            <h2 class="text-xl font-semibold text-black dark:text-white">Migz so pretty!! </h2>
            <p class="mt-4 text-sm/relaxed">Brief description for the third news article.</p>
        </div>
    </a>
</section>
    ...
    >
        ...
        <div class="flex flex-col gap-6 justify-center text-center lg:text-left">
            ...
            <p class="text-sm/relaxed text-gray-700 dark:text-gray-300">
                Barangay San Antonio is a peaceful, progressive, and highly-urbanized community in Pasig City. Consists of cooperative and morally upright residents, ambitious and responsive business owners and corporate managers, and committed and visionary leaders, Barangay San Antonio works hand in hand with constituents to sustain its clean, green, safe, and healthy environment and to develop its physical and economic growth.
            </p>
            <a href="#"
